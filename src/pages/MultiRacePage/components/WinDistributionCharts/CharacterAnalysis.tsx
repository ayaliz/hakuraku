        ...
        <div className="pie-chart-container">
            ...
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-around", gap: "20px" }}>
                ...
                <div style={{ textAlign: "center" }}>
                    ...
                    {winsAll.length > 0 ? (
                        <PieChart slices={winsAll} size={200} unit="wins" chartId="chara-wins-all" />
                    ) : (
                ...
                <div style={{ textAlign: "center" }}>
                    ...
                    {winsOpp.length > 0 ? (
                        <PieChart slices={winsOpp} size={200} unit="wins" chartId="chara-wins-opp" />
                    ) : (
                        <div style={{ height: 200, width: 220, display: "flex", alignItems: "center", justifyContent: "center", color: "#718096" }}>
                            No wins
                        </div>
                ...
                <div style={{ textAlign: "center" }}>
                    ...
                    {pop.length > 0 ? (
                        <PieChart slices={pop} size={200} unit="entries" chartId="chara-pop" />
                    ) : (
                        <div style={{ height: 200, width: 220, display: "flex", alignItems: "center", justifyContent: "center", color: "#718096" }}>
                            No entries
                        </div>
