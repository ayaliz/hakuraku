        ...
        <div ref={rootRef} className="rr-root">
            ...
            >
                ...
                <div className="d-flex align-items-center justify-content-between mt-2 rr-playback-row">
                    <div className="d-flex align-items-center flex-grow-1 rr-playback-main">
                        ...
                        <span className="ms-3 rr-playback-time">
                            <span className="rr-playback-time-sizer" aria-hidden="true">{endTime.toFixed(2)}s / {endTime.toFixed(2)}s</span>
                            <span className="rr-playback-time-value">{clampedRenderTime.toFixed(2)}s / {endTime.toFixed(2)}s</span>
                        </span>
                    </div>
                    <div className="ms-3">
                        <InfoHover />
