...
export function useToggles(initial?: Partial<Toggles>) {
    const [t, set] = useReducer(
        ...
        { speed: false, accel: false, skills: true, slopes: true, blocked: true, course: true, positionKeep: false, hp: false, heuristics: false, skillDuration: false, minimap: false, ...(initial || {}) }
    );
