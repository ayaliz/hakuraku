...
const SetupGuidePage = () => {
    return (
        <div>
            ...
            <p>The plugin API is more recent than the latest release of Hachimi-Unity2020. You will need to compile the current version yourself. If you need help, please consult a friend or your favorite LLM. I can not provide compiled binaries for someone else's project.</p>
			...
			<p>Download <a href="data/horseACT.dll" download><strong>horseACT.dll</strong></a> and place it in the root of your game folder. This is a hachimi plugin to capture race data.</p>
    ...
    "load_libraries": [
        "horseACT.dll"
            ...
            <p>Restart your game if it's currently running. Your career and room matches (including CM) will now be saved in the <strong>Saved races</strong> folder inside of your Documents folder.</p>
