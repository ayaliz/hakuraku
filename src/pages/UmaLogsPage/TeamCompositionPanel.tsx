...
import type { TeamCompositionStats } from "../MultiRacePage/types";
...
const TeamCompositionPanel: React.FC<TeamCompositionPanelProps> = ({ teamStats }) => {
